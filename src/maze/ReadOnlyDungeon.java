...
/**
 * The interface to implement the read only dungeon. The dungeon that will be created can be
 * wrapping or non-wrapping. It will have edges assigned to it based on the interconnectivity.
 */
